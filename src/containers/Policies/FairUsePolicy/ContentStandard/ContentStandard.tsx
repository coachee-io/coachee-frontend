...
class ContentStandard extends PureComponent {
  render() {
    return (
      <>
        ...
        <UL>
          ...
          <LI>
            <Para>
              complies with the law applicable in England and Wales.
            </Para>
          </LI>
        </UL>
        <Para>
          7.3. All content must not:
        </Para>
        <UL>
          <LI>
            <Para>
          ...
          <LI>
            <Para>
              ...
              that members of the public to whom the statement is, or is to be, published are likely to understand as a direct or indirect
