    ...
    return (
      <>
        <H3 id="coaching-programmes">
          7. Coaching programmes
        </H3>
        <Para>
          7.1. Certain programmes may be subject to additional terms and conditions,
          in which case they will be displayed on our Platform.
        </Para>
        <Para>
          7.2. You should also remember that all coaching services are provided by our Partners, and as such,
        ...
        <Para>
          7.3. Our platform works by booking and paying whole coaching programmes,
        ...
        <Para>
          7.4. Please note that all coaching programmes are for your personal use and you cannot sell,
