  ...
  render() {
    return (
      <>
        ...
        <Para>
          12.1. If you have any issues relating to the use of our Platform, your coach, and/or in relation to the payments,
        ...
        <Para>
          12.2. When we reasonably believe that you have not followed these Terms,
