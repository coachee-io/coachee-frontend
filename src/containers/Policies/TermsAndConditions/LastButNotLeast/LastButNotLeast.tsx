  ...
  render() {
    return (
      <>
        ...
        <Para>
          14.2. These Terms are between you and us. No other person shall have any rights to enforce any of these Terms.
        </Para>
        <Para>
          14.3. Each of the paragraphs of these Terms operates separately.
        ...
        <Para>
          14.4. These Terms are governed by English law and you can bring legal proceedings against us in the English courts.
