...
class OurResponsibility extends PureComponent {
  render() {
    return (
      <>
        ...
        <Para>
          11.1. If we fail to comply with these Terms, we are responsible for loss or
        ...
        <Para>
          11.2. Please also refer to paragraph 6.2 above for more details about our responsibility
        ...
        <Para>
          11.4. Our Platform is made available to you for private use only.
