    ...
    return (
      <>
        <H3 id="platform-availability">
          5. Availability of our platform and the benefits
        </H3>
        <Para>
          5.1. We cannot guarantee that our Platform, or any content on it, will always be available or be uninterrupted.
        ...
        <Para>
          5.2. All coaches and coaching programmes are subject to availability.
